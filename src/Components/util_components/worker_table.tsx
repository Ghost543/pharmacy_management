    ...
    return (
        <div
            ...
            <div
                ...
                <span
                    className={`w-full max-h-fit flex flex-row justify-center items-center`}></span>
            </div>
            <ul
                className={`w-full max-h-fit flex flex-col gap-2 scroll-smooth overflow-scroll`}>
                {body.map((row, i) => (
                    <li
                        ...
                        <div
                            ...
                            <span
                                ...
                                <p
                                    className={`w-fit h-fit px-1 rounded-md ${
                                        roleSelector(row.role).style
                                    }`}>
                                    {roleSelector(row.role).name}
                                </p>
                            </span>
                            <span
                            ...
                            <span
                                className={`w-full max-h-fit flex flex-row justify-center items-center`}>
                                <p
                                    className={`w-fit text-xs h-fit px-1 rounded-full ${
                            ...
                            <span
                                ...
                                className={`w-full max-h-fit flex flex-row justify-center items-center`}>
                                <PiDotsThreeVertical
                                    className={`cursor-pointer text-gray-400 text-3xl hover:text-sky-600`}
                                />
                            </span>
                        </div>
