...
export const Pagination: FC<{ pages: number }> = ({ pages }) => {
    ...
    const nexPage = (e: React.MouseEvent<HTMLLIElement>) => {
        ...
        children[
            currentPage + 1
        ].className = `relative block rounded  px-3 py-1.5 text-sm transition-all duration-300 cursor-pointer text-white bg-gray-800 hover:bg-gray-800 hover:text-while`;
