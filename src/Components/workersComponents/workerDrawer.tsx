...
export const WorkerDrawer: FC = () => {
    ...
    return (
        <div
            ...
            <div
                className={`w-full max-h-fit flex flex-col items-end gap-1 p-2`}>
                ...
                <div className={`w-full h-fit flex flex-row justify-end`}>
                    ...
                    <select
                        ...
                        <option value="all" selected={worker === undefined}>
                            All
                        </option>
                        <option
                            value="admin"
